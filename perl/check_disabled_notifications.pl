...
my $serviceDat = "/var/nagios/status.dat";

open(INPUT, ${serviceDat}) or die "Unable to open ${serviceDat}: $!";
...
my $nagiosurl = "<URL_OF_YOUR_NAGIOS_SERVER>";
my $emailAddress = "foo\@bar.com";
