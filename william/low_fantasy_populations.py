...
Largestcity= int(sqrt(Population)*12)
Cities=1
print("The population of your kingdom's largest city is: ", Largestcity)
City=int(Largestcity*.2)
Cities=2
print("The second largest city in your kingdom is: ", City)
if City >=80000:
    print("The third largest city in your kingdom is: ",City*.1)
    City=int(City*.1)
    Cities=3
if City >=80000:
    print("The fourth largest city in your kingdom is: ",City*.1)
    City=int(City*.1)
    Cities=4
if City >=80000:
    print("The fifth largest city in your kingdom is: ",City*.1)
    City=int(City*.1)
    Cities=5
if City >=80000:
    print("The sixth largest city in your kingdom is: ",City*.1)
    City=int(City*.1)
    Cities=6
if City >=80000:
    print("The seventh largest city in your kingdom is: ",City*.1)
    City=int(City*.1)
    Cities=7
if City >=80000:
    print("The eigth largest city in your kingdom is: ",City*.1)
    City=int(City*.1)
    Cities=8
if City >=80000:
    print("The ninth largest city in your kingdom is: ",City*.1)
    City=int(City*.1)
    Cities=9
if City >=80000:
    print("The tenth largest city in your kingdom is: ",City*.1)
    City=int(City*.1)
    Cities=10
else:
    Towns=int(Cities*2)
